...
import com.app.converter.ItemConverter;
import com.app.model.Devoloper;
...
public class AppConfig implements WebMvcConfigurer{
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(Employee.class,User.class,Devoloper.class,Project.class,OrderMethod.class,WhUserType.class,Item.class,PurchaseOrder.class,ShipmentType.class,Uom.class,Document.class);
